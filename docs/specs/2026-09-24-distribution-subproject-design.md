...
crates/platform-store/          + rules module, migration 0004
...
| DM1 | Migration 0004, store rules module, `admin rules` | publish tests pass; exact bytes stored |
...
later migration.
- (a) **R** Distribution defines them here in migration 0004. The console
