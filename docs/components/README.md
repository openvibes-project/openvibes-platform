...
| `openvibes-vulns` | library (service in VM2b) | Fedora advisories, exact RPM version matching, vulnerability lifecycle (VM2) | [openvibes-vulns.md](openvibes-vulns.md) |
