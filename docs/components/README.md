...
| `platform_store::console_auth` | module | local identity/session store, access inventory, role bindings, asset-group/tag changes, and enrollment-token management (C3) | [console-auth-store.md](console-auth-store.md) |
...
| `console-auth-http` | console module | pre-auth, local login/logout, scoped read models, enrollment-token API, and per-request capability resolution (C3) | [console-auth-http.md](console-auth-http.md) |
| `console-auth-ui` | web module | local login page, session gate, logout action, and enrollment-token management (C3) | [console-auth-ui.md](console-auth-ui.md) |
