...
| `platform-store` | library | schema 16, vulnerability data/enrichment, rule distribution, console identity/sessions, triage, partitions, status, tokens, agents, CA certificates (PM1, PM2, VM0–VM5, C2, C3) | [platform-store.md](platform-store.md) |
