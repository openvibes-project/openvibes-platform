...
| `openvibes-console` | web application and `/api/v1` | C0 foundation implemented; contract/browser/offline-build work remains | [openvibes-console.md](openvibes-console.md) |
