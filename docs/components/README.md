...
| `platform_store::console_auth` | module | local identity/session store, access inventory, role bindings, asset-group selector writes, and previewed agent-tag updates (C3) | [console-auth-store.md](console-auth-store.md) |
